...
ALTER TABLE "scraper_commands" ADD COLUMN "expires_at" timestamp;--> statement-breakpoint
UPDATE "scraper_commands" SET "expires_at" = NOW() + interval '24 hours' WHERE "expires_at" IS NULL;--> statement-breakpoint
ALTER TABLE "scraper_commands" ALTER COLUMN "expires_at" SET NOT NULL;--> statement-breakpoint
