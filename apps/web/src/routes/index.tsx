            ...
            <form onSubmit={handleSearch} className="minato-panel minato-sheen space-y-3 p-4 sm:p-5">
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-14 pl-8 pr-3 sm:pr-36 text-base font-mono bg-background border-border/50 hover:border-border focus-visible:border-primary/50 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-none transition-colors placeholder:text-muted-foreground/45 placeholder:font-mono"
                />
                      ...
                      {instantResults.data.hits.map((result, i) => (
                        ...
                        >
                          <div className="group flex items-center gap-4 px-0 py-3 border-b border-border/30 hover:bg-primary/3 transition-colors">
                            {/* Index */}
                            <span className="font-mono text-[11px] text-muted-foreground/50 w-4 shrink-0 select-none tabular-nums text-right">
                              {i + 1}
                            </span>
                            ...
                            <div className="hidden sm:flex items-center gap-1.5 shrink-0">
                              ...
                              {result.resolution && (
                                <span className="font-mono text-[11px] px-1.5 py-0.5 border border-primary/30 text-primary/80">
                                  {result.resolution}
                                </span>
                              )}
                            </div>

                            <ArrowRight className="size-3.5 text-muted-foreground/40 group-hover:text-primary/70 shrink-0 transition-colors" />
                          </div>
                        </Link>
                      ))}
