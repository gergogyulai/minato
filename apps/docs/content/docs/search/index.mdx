...
| Filter | Description |
|---|---|
| **Type** | One or more content types (multi-select) |
| **Resolution** | One or more resolutions (multi-select) |
| **Genre** | One or more genres from enrichment metadata (multi-select) |
| **Group** | One or more release groups (multi-select) |
| **Year** | Release year range — min and/or max |
| **Size** | File size range in GB — min and/or max |
| **Min seeders** | Lower bound on the seeder count |
