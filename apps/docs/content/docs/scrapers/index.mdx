---
title: Scrapers
description: Add data sources to your Minato instance from the registry or a Git repository.
---
...
Want to write your own scraper?

<Cards>
  <Card title="Writing a community scraper" href="/docs/scrapers/community" />
  <Card title="Sidecar scrapers" href="/docs/scrapers/sidecar" />
</Cards>
