...
|---|---|---|
| `name` | ✅ | Unique ID — kebab-case, used as the scraper's internal identifier |
| `title` | ✅ | Display name shown in the dashboard and registry |
| `description` | ✅ | Short description shown in the registry listing |
| `author` | ✅ | Your handle or name |
| `repository` | ✅ | Source URL — where users file issues and find your code |
| `module` | ✅ | Entrypoint path, relative to the package root |
